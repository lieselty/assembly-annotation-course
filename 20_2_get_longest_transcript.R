# first, run samtools faidx on the transcripts.fasta.renamed.filtered.fasta file
library(dplyr)
library(seqinr)
...
transcript <- read.table("assembly.all.maker.transcripts.fasta.renamed.filtered.fasta.fai")
...
fasta_transcript <- read.fasta("assembly.all.maker.transcripts.fasta.renamed.filtered.fasta")
...
output_fasta <- "longest_transcript.fasta"
